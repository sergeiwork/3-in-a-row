...
namespace ThreeInARow.Presentation
{
    ...
    public sealed partial class ThreeInARowApp : MonoBehaviour
    {
        ...
        private void BuildHelp(Action back)
        {
            ...
            scroll.Add(HelpRow("gem.ember", "ПЛАМЯ", "Каждый убранный кристалл наносит 3 прямого урона. Особая Искра наносит 12 урона."));
            scroll.Add(HelpRow("gem.tide", "ПРИЛИВ И КОНЦЕНТРАЦИЯ", "Каждый кристалл даёт 1 ед. концентрации. Каждые 3 ед. автоматически превращаются в 9 урона. Особый Поток даёт 5 ед."));
            scroll.Add(HelpRow("gem.venom", "ЯД И ТОКСИН", "Каждый кристалл даёт 1 ед. токсина. Каждые 5 ед. наносят 13 урона и дают врагу заряд отравления. Особая Спора даёт 5 ед."));
            scroll.Add(HelpRow("gem.volt", "РАЗРЯД", "Каждый кристалл наносит 3 урона. Каждые 3 убранных Разряда сокращают перезарядку обоих активных навыков на 1. Особый Заряд наносит 10 урона и тоже ускоряет оба навыка."));
