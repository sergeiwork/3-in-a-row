...
- The canvas renders at 1080×1920 by default but UI Toolkit scales from a 720×1280 logical reference and applies the device safe area. This keeps live text and touch targets readable on dense mobile displays. The square board is capped independently of screen height so both 16:9 and 20:9 portrait layouts retain the enemy intent, resources, active controls, and generous cell hit regions.
